...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.76\linewidth]{gambar/Config_1_all_identify.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.76\linewidth]{gambar/Config_1_all_identify_marker_7_zoom.png}
...
\begin{figure}[H]
	...
	\begin{subfigure}{0.48\textwidth}
		\centering
		\includegraphics[width=0.8\linewidth]{gambar/ROR_bar.png}
		\caption{}
		\label{fig:ROR_1,6,7}
	\end{subfigure}
	\centering
	\begin{subfigure}{0.48\textwidth}
		\centering
		\includegraphics[width=0.8\linewidth]{gambar/ROP_bar.png}
		\caption{}
		\label{fig:ROP_1,6,7}
	\end{subfigure}
	\\
	...
	\begin{subfigure}{0.48\textwidth}
		\centering
		\includegraphics[width=0.8\linewidth]{gambar/ROY_bar.png}
		\caption{}
		\label{fig:ROY_1,6,7}
	\end{subfigure}
	\centering
	\begin{subfigure}{0.48\textwidth}
		\centering
		\includegraphics[width=0.8\linewidth]{gambar/ACC-Y_bar.png}
		\caption{}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\linewidth]{gambar/damp_motion_heli.png}
	\caption{Identifikasi secara visual saat helikopter masih memberikan respon setelah \textit{input} nya berhenti pada kondisi-1.}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.58\linewidth]{gambar/jumlah-respon_masing2_channel.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{gambar/validation_time_domain.jpg}
